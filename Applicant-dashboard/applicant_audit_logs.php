...
require_once './applicant_header.php';
...
require_once './applicant_sidebar.php';
?>
        ...
        <form method="GET" class="filters-form">
            <div class="filter-row">
                ...
                <div class="filter-actions">
                    ...
                    <a href="applicant_audit_logs.php" class="btn btn-secondary">Clear</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="stats-grid">
        ...
        $stats_sql = "
            SELECT
                ...
                COUNT(CASE WHEN action = 'view_application' THEN 1 END) as viewed_applications
            FROM audit_logs
            WHERE user_id = ?
        ";
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                <h3><?= number_format($stats['viewed_applications']) ?></h3>
...
<?php require_once './applicant_footer.php'; ?>
