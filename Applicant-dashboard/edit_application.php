...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        error_log("Failed to fetch application for edit: " . $e->getMessage());
        $application = null;
        $form_details = [];
    }
    ...
    if ($application) {
        try {
            ...
            error_log("Failed to fetch documents for edit_application: " . $e->getMessage());
            $documents = [];
        }
    }
}
                        ...
                        <?php else: ?>
                            <?php foreach ($documents as $doc): ?>
                                ...
                                <div class="document-item">
                                    ...
                                    <a href="<?= $file_path ?>" class="btn btn-secondary" target="_blank" style="padding: 8px 16px; font-size: 0.9rem;" title="Open <?= htmlspecialchars($doc_label) ?>">
