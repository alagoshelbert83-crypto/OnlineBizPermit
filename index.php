<?php
// index.php - Modern Get Started Page (Root Landing Page)
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="container">
    ...
    <div class="left">
      ...
      <img src="Applicant-dashboard/logo.png" alt="Business Illustration">
      <p>
    ...
    <!-- Right Section -->
    <div class="right">
      <img src="Applicant-dashboard/office.png.png" alt="Office Illustration">
    </div>
  </div>
</body>
</html>
