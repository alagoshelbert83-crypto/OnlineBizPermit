...
if (!$is_admin) {
    ...
    <div class="main">
        ...
        <div class="message error" style="margin: 20px; padding: 20px; border-left: 4px solid #ef4444;">
            ...
            <p style="margin-top: 10px; margin-bottom: 0;">Only administrators can access the User Management page. If you believe this is an error, please contact your system administrator.</p>
        </div>
    </div>
    <?php
